  ...
  return (
    <div className='min-h-screen mt-20' > 
      <div className='flex p-3 max-x-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <p className='mt-5 text-sm'>This is a Blog App. You can Sign    in with your email and password or with google .</p>
        </div>
        {/* right */}
        <div className='flex-1'>
          ...
          <div className='flex gap-2 mt-5 text-sm'>
            ...
            <Link to="/signup" className='text-indigo-500 dark:text-indigo-400' >Signup</Link>
          </div>
          {
            errorMessage && (
